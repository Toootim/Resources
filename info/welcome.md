...
- מסטודון היא רשת חברתית מבוזרת, שתווותים הוא רק מופע (שרת) אחד מתוכה. מסטודון בעצמה היא חלק מפרוייקט גדול עוד יותר, של רשתות מבוזרות שיכולות לדבר אחת עם השניה, שנקרא לפעמים "הפדרציה" ולפעמים "פדיברס". פרטים נוספים:
...
## איך למצוא אנשים מעניינים (לכתוב פוסט)  
...
- כדי למצוא אנשים לפי תחומי עניין, נסו את https://fediverse.info/explore/people או את https://communitywiki.org/trunk
